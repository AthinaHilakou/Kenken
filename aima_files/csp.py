...
import aima_files.search as search
from aima_files.utils import argmin_random_tie, count, first, extend
...
def ac_search_solver(csp, arc_heuristic=sat_up):
    ...
    from aima_files.search import depth_first_tree_search
    solution = None
    try:
